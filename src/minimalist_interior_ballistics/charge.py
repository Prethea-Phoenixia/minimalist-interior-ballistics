...
class Charge(Propellant):
    ...
    reduced_burnrate: float, optional
        ...
        `minimalist_interior_ballistics.form_function.FormFunction.e_1` and
    ...
    ----------
    Z_k: float
        cached from `minimalist_interior_ballistics.form_function.FormFunction.Z_k`.
    theta: float
        see documentation for `Propellant`
...
Charge.burn_rate_coefficient and FormFunction.e_1"
    ...
    def from_propellant(
        ...
        *,
        ...
        form_function:
            `minimalist_interior_ballistics.form_function.FormFunction` object that describes the geometry of this propellant.
