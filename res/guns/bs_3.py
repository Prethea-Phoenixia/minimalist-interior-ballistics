...
kgf/cm^2, from copper crusher gauge. The adopted computational average pressure is \
3100 kgf/cm^2.\n"
    + ref,
    ...
    pressure_target=PressureTarget.average_pressure(3300e2 * kgf_dm2),
)
...
bs_3_apbc = Gun(
    ...
    description="Type 1944 100mm cannon is the domestic designation for the Soviet 100mm \
field gun M1944 (BS-3). Nominal velocity is given as either 887 m/s or 902.5m/s. Nominal \
