...
m_46_full = KnownGunProblem(
    name="Type 1959 130mm Cannon (WB005P HE-Frag, Full Charge) (M-46)",
...
This case represents when both are left in. Nominal velocity is 930m/s.\n\
Reference:\n\
 《火炮内弹道计算手册》(1987)\n\
 《火炸药手册 (增订本）第二分册》(1981).",
    ...
    pressure_target=PressureTarget(3250e2 * kgf_dm2, target=PressureTarget.AVERAGE),
)

m_46_one = Gun(
    name="Type 1959 130mm Cannon (WB005P HE-Frag, No.1 Charge) (M-46)",
    description="Type 1959 130mm cannon is the designation for domestically produced \
